> ## ⚠️ DESACTUALIZADO — leer antes el README.md
>
> Revisión del **15/08/2026** con acceso real a la web y con Search Console.
> Estas instrucciones se escribieron a ciegas y **varias premisas resultaron
> falsas**. En concreto:
>
> - El blog tiene **22 entradas, no 9**, y 10 no son alcanzables desde `/blog/`.
> - El título del post de Starlink **ya está arreglado** (53 car., no 131).
> - El post 1 **ya está publicado** con su título y meta nuevos.
> - De las «3 páginas con cero clics», **dos ya estaban optimizadas**; y el
>   PowerStream, lejos de tener 2 visitas, tiene **131 clics**: es la mejor
>   ficha del sitio.
> - `/nueva-entrada-blog/` tiene **151 impresiones y 1 clic**: cambiarle el slug
>   está bien, pero no es la prioridad número uno que se decía aquí.
> - **16 de los 17 productos** que enlazaban los posts están **agotados**.
> - El consumo del Starlink Standard del borrador (45-75 W) **era incorrecto**:
>   la hoja oficial de SpaceX dice **75-100 W**.
>
> El orden de trabajo correcto, con clics reales, está en la sección 11 del
> **README.md**. Lo de abajo se conserva solo como registro de lo que se pidió.
